...
public interface IGrafoDirigido {
	...
	Double [][] floyd();
        ...
        Double[] dijkstra(Comparable etiquetaOrigen);
   ...
   /**
    ...
    boolean esConexo(boolean[][] warshall);
    
    boolean esConexo();
    
    void desvisitarVertices();
    
    LinkedList<TVertice> bea();
    
    LinkedList<TVertice> bpf();
    
    LinkedList<TVertice> bpf(Comparable etiquetaOrigen);
    
    LinkedList<TVertice> bpf(TVertice vertice);
    ...
    LinkedList<TVertice> clasificacionTopologica(Comparable etiquetaVertice);
