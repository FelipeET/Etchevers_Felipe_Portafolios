...
public class PruebaGrafo {
    ...
    public static void main(String[] args) {
        ...
        TGrafoDirigido grafo = (TGrafoDirigido) UtilGrafos.cargarGrafo("./UT7/PD4/aeropuertos.txt",
                "./UT7/PD4/conexiones.txt",false, TGrafoDirigido.class);
       ...
       /* Object[] etiquetasarray = grafo.getEtiquetasOrdenado();
        ...
        String[] vertices = ManejadorArchivosGenerico.leerArchivo("./UT7/PD4/aeropuertos.txt", false);
        int i = 0;
